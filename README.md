...
15. `[x]` **Фронтенд: Логика drag-and-drop для дел**
...
16. `[x]` **Фронтенд: Взаимодействие с API для дел**
...
17. `[x]` **Бэкенд: Миграции для таблицы `expense_categories`**
...
18. `[x]` **Бэкенд: Предопределение категорий трат**
...
20. `[x]` **Бэкенд: Расчет заработка и трат**
...
22. `[x]` **Фронтенд: Отображение финансовых показателей**
...
23. `[x]` **Бэкенд: Валидация и Санитаризация всех входных данных**
...
25. `[x]` **Фронтенд: Обработка ошибок UI**
...
26. `[x]` **Фронтенд: Оптимизация производительности**
...
27. `[x]` **Фронтенд: Улучшение пользовательского опыта (UX)**
...
28. `[x]` **Бэкенд: Скрипты развертывания**
...
29. `[x]` **Фронтенд: Сборка для продакшена**
...
30. `[x]` **Документация: README.md**
    ...
    *   **Ожидаемый результат:** Доступная документация для разработчиков.
